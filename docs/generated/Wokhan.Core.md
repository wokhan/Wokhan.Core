...
## Wokhan.Core namespace

| public type | description |
| --- | --- |
| static class [UnitFormatter](./Wokhan.Core/UnitFormatter.md) | A static class offering a single method to help formatting numeric values. |
