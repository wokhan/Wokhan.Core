...
public static class EnumerableExtensions
{
    ...
    public static IEnumerable<T> ApplyToAll<T>(this IEnumerable<T> src, Action<T> action)
    {
        ...
        Contract.Requires(action is not null);

        return src.Select(o => { action(o); return o; });
    }
    ...
    {
        Contract.Requires(src is not null);
        Contract.Requires(indexes is not null);
    ...
    {
        Contract.Requires(src is not null);
        Contract.Requires(sorters is not null);
    ...
    {
        Contract.Requires(src is not null);
        Contract.Requires(newItems is not null);
    ...
    {
        Contract.Requires(src is not null);
        Contract.Requires(targetclass is not null);
        Contract.Requires(attributes is not null);
    ...
    {
        Contract.Requires(src is not null);
        Contract.Requires(added is not null);
    ...
    {
        Contract.Requires(src is not null);
        Contract.Requires(keysSelector is not null);
        Contract.Requires(pivotSelectorExpr is not null);
