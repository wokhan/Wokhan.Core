...
internal sealed class Set<TElement>
{
    ...
    public bool Add(TElement value)
    {
        ...
        if (Contains(value, hashCode, _comparer))
        {
            return false;
        }
    ...
    private bool Contains(TElement value, int hashCode, IEqualityComparer<TElement> comparer)
    {
    ...
    {
        int hashCode = InternalGetHashCode(value);
        return Contains(value, hashCode, comparer);
    }
    ...
    private int InternalGetHashCode(TElement value) => value is null ? 0 : _comparer.GetHashCode(value) & 0x7FFFFFFF;
